...
const ProjectDashboard: React.FC<ProjectDashboardProps> = ({ 
  ...
  return (
    <div className="h-full flex flex-col p-4 sm:p-6 overflow-y-auto custom-scrollbar animate-fade-in bg-transparent transition-all duration-300">
      ...
      <div className="mb-8">
        <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] mb-4 border-b border-slate-500/10 pb-2">Integração GitHub</h4>
        {project.githubRepo ? (
          ...
          <div className="p-6 border-2 border-dashed border-slate-300 dark:border-slate-800 text-center">
            <p className="text-[9px] text-slate-500 font-bold uppercase mb-4">REPOSITÓRIO NÃO VINCULADO</p>
            <button 
              onClick={() => onEditProject(projectId)}
              className="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-[8px] font-black uppercase text-emerald-600 hover:bg-emerald-500/10 transition-all border border-emerald-600/20"
            >
