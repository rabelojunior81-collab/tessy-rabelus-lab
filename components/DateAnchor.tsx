...
export const DateAnchor: React.FC<DateAnchorProps> = ({ groundingEnabled }) => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 bg-slate-900/60 backdrop-blur-xl border-2 border-emerald-500 px-4 py-2 shadow-[4px_4px_0_rgba(16,185,129,0.5)] rounded-none flex items-center gap-3 transition-all duration-300">
